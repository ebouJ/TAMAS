...
public class JobPostDisplayPage extends JFrame {
	...
	private String[] jobChoice223;
	private String[] jobChoice321;
	...
	public void initUI(){
		...
		courseChoice = new String[] {"ECSE 223", "ECSE321"};
		jobChoice223 = new String[] {"ECSE223 TA", "ECSE223 Grader"};
		jobChoice321 = new String[] {"ECSE321 TA", "ECSE321 Grader"};
		...
		jobs = new JList<String>(jobChoice223);
	...
	private void refreshData(){
		...
		currentCourse = (String)courses.getSelectedItem();
		
		if(currentCourse.equals(courseChoice[0])){
			jobs = new JList<String>(jobChoice223);
			System.out.println("223");
		}
		else{
			jobs = new JList<String>(jobChoice321);
