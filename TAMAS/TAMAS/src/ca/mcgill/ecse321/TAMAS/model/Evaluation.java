...
public class Evaluation
{
  ...
  public Evaluation(Instructor aInstructor, int aNumberOfHoursForJob, int aSalaryForJob, boolean aIsTaJobForJob, boolean aIsAssignedToStudentForJob, boolean aIsAllocatedToStudentForJob, String aDescriptionForJob, String aDeadlineForJob, Course aCourseForJob, Tamas aTamasForJob, Student aJobCandidateForJob)
  {
    boolean didAddInstructor = setInstructor(aInstructor);
    if (!didAddInstructor)
    {
    ...
    job = new Job(aNumberOfHoursForJob, aSalaryForJob, aIsTaJobForJob, aIsAssignedToStudentForJob, aIsAllocatedToStudentForJob, aDescriptionForJob, aDeadlineForJob, aCourseForJob, aTamasForJob, this, aJobCandidateForJob);
  }
