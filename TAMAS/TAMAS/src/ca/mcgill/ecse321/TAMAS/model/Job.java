...
public class Job
{
  ...
  public Job(int aNumberOfHours, int aSalary, boolean aIsTaJob, boolean aIsAssignedToStudent, boolean aIsAllocatedToStudent, String aDescription, String aDeadline, Course aCourse, Tamas aTamas, Evaluation aEvaluation, Student aJobCandidate)
  {
  ...
  public Job(int aNumberOfHours, int aSalary, boolean aIsTaJob, boolean aIsAssignedToStudent, boolean aIsAllocatedToStudent, String aDescription, String aDeadline, Course aCourse, Tamas aTamas, Instructor aInstructorForEvaluation, Student aJobCandidate)
  {
    numberOfHours = aNumberOfHours;
    salary = aSalary;
    isTaJob = aIsTaJob;
