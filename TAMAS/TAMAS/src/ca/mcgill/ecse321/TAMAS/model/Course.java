...
public class Course
{
  ...
  public Job addJob(int aNumberOfHours, int aSalary, boolean aIsTaJob, boolean aIsAssignedToStudent, boolean aIsAllocatedToStudent, String aDescription, String aDeadline, Tamas aTamas, Evaluation aEvaluation, Student aJobCandidate)
  {
    return new Job(aNumberOfHours, aSalary, aIsTaJob, aIsAssignedToStudent, aIsAllocatedToStudent, aDescription, aDeadline, this, aTamas, aEvaluation, aJobCandidate);
  }
